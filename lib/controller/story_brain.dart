import 'package:destini/model/story.dart';
import 'package:get/get.dart';

class StoryBrain extends GetxController {
  RxBool isButtonVisible = RxBool(true);
  RxList<Story> storyData = [
    Story(
  ...
  void buttonShouldBeVisible() {
    //You could also just check if (_storyNumber.value < 3)
